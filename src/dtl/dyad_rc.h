...
enum dyad_core_return_codes {
    ...
    DYAD_RC_BAD_STORAGEGRAPH_OP = -17,  // Bad operation on the storage graph
    DYAD_RC_NO_TRANSFER_EXPECTED = -18, // Broker indicated that transfer should not
                                        // occur based on storage graph search
};
