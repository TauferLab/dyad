...
struct dyad_dtl {
    ...
    dyad_rc_t (*establish_connection) (struct dyad_dtl* self, dyad_dtl_comm_mode_t comm_mode);
...
dyad_rc_t dyad_dtl_init (dyad_dtl_t** dtl_handle, dyad_dtl_mode_t mode, flux_t* h, bool debug);
