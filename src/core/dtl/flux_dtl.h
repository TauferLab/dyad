...
dyad_dtl_err_t dyad_dtl_flux_establish_connection(
        dyad_dtl_flux_t *dtl_handle, uint32_t producer_rank);

dyad_dtl_err_t dyad_dtl_flux_rpc_pack(dyad_dtl_flux_t *dtl_handle,
        const char *upath, json_t **packed_obj);

dyad_dtl_err_t dyad_dtl_flux_recv(dyad_dtl_flux_t *dtl_handle,
        flux_future_t *f, void **buf, size_t *buflen);

dyad_dtl_err_t dyad_dtl_flux_close_connection(
